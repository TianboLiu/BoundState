...
int main(int argc, char * argv[]){
  ...
  for (int i = 0; i < Nsim; i++){
    ...
    if (true){
      ...
      weight = GenerateEvent_eNKK_withElectroproductionPhiGold(ki, kf);//Generate a unbound event with phi production
      P0_p = kf[1];
      P0_Kp = kf[2];
      P0_Km = kf[3];
      P0_all = P0_p + P0_Kp + P0_Km;
      ...
      weight = GenerateEvent_eNKK_withElectroproductionLambda1520Gold(ki, kf);//Generate a unbound event with Lambda1520 production
      P0_p = kf[1];
      P0_Kp = kf[2];
      P0_Km = kf[3];
      P0_all = P0_p + P0_Kp + P0_Km;
      ...
      weight = GenerateEvent_eNKK_withElectroproductionKKGold(ki, kf);//Generate a unbound event with direct KK production
      P0_p = kf[1];
      P0_Kp = kf[2];
      P0_Km = kf[3];
      P0_all = P0_p + P0_Kp + P0_Km;
