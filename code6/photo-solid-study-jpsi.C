...
int main(const int argc, const char * argv[]){
  ...
  if (argc > 1) Nsim = atoi(argv[1]);
    ...
    cout << "./photo-solid-study <Nsim>" << endl;
    return 0;
  }
  ...
  // detected 1
  TFile * fall1 = new TFile("result-photon/Dsolid1.root", "RECREATE");
  ...
  TFile * fsub1 = new TFile("result-photon/Dsolidsub1.root", "RECREATE");
  ...
  // detected 2
  TFile * fall2 = new TFile("result-photon/Dsolid2.root", "RECREATE");
  ...
  TFile * fsub2 = new TFile("result-photon/Dsolidsub2.root", "RECREATE");
  ...
  // detected 3
  TFile * fall3 = new TFile("result-photon/Dsolid3.root", "RECREATE");
  ...
  TFile * fsub3 = new TFile("result-photon/Dsolidsub3.root", "RECREATE");
  ...
  // detected 4
  TFile * fall4 = new TFile("result-photon/Dsolid4.root", "RECREATE");
  ...
  TFile * fsub4 = new TFile("result-photon/Dsolidsub4.root", "RECREATE");
  ...
  // detected 5
  TFile * fall5 = new TFile("result-photon/Dsolid5.root", "RECREATE");
  ...
  TFile * fsub5 = new TFile("result-photon/Dsolidsub5.root", "RECREATE");
  ...
  // detected 6
  TFile * fall6 = new TFile("result-photon/Dsolid6.root", "RECREATE");
  ...
  TFile * fsub6 = new TFile("result-photon/Dsolidsub6.root", "RECREATE");
  ...
  for (Long64_t i = 0; i < Nsim; i++){
	...
	if (ki[0].E() < 8.2){
	  hMJpsisub1->Fill( (kf[1]+kf[2]).M(), weight);
	  ...
	  hPJpsisub1->Fill( (kf[1]+kf[2]).P(), weight);
	  hFermiPPJpsisub1->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	}
      }
	...
	if (ki[0].E() < 8.2){
	  hMJpsisub2->Fill( (kf[1]+kf[2]).M(), weight);
	  ...
	  hPJpsisub2->Fill( (kf[1]+kf[2]).P(), weight);
	  hFermiPPJpsisub2->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	}
      }

      //case 3
      if (CheckAcceptance(kf[1], 8.0, 24.0) * CheckAcceptance(kf[2], 8.0, 24.0) * CheckAcceptance(kf[0], 8.0, 24.0)){
	hMJpsi3->Fill( (kf[1]+kf[2]).M(), weight);
	...
	hPJpsi3->Fill( (kf[1]+kf[2]).P(), weight);
	hFermiPPJpsi3->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	
	if (ki[0].E() < 8.2){
	  hMJpsisub3->Fill( (kf[1]+kf[2]).M(), weight);
	  ...
	  hPJpsisub3->Fill( (kf[1]+kf[2]).P(), weight);
	  hFermiPPJpsisub3->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	}
      }

      //case 4
      if (CheckAcceptance(kf[1], 9.0, 26.0) * CheckAcceptance(kf[2], 9.0, 26.0) * CheckAcceptance(kf[0], 9.0, 26.0)){
	hMJpsi4->Fill( (kf[1]+kf[2]).M(), weight);
	...
	hPJpsi4->Fill( (kf[1]+kf[2]).P(), weight);
	hFermiPPJpsi4->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	
	if (ki[0].E() < 8.2){
	  hMJpsisub4->Fill( (kf[1]+kf[2]).M(), weight);
	  ...
	  hPJpsisub4->Fill( (kf[1]+kf[2]).P(), weight);
	  hFermiPPJpsisub4->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	}
      }

      //case 5
      if (CheckAcceptance(kf[1], 10.0, 28.0) * CheckAcceptance(kf[2], 10.0, 28.0) * CheckAcceptance(kf[0], 10.0, 28.0)){
	hMJpsi5->Fill( (kf[1]+kf[2]).M(), weight);
	...
	hPJpsi5->Fill( (kf[1]+kf[2]).P(), weight);
	hFermiPPJpsi5->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	
	if (ki[0].E() < 8.2){
	  hMJpsisub5->Fill( (kf[1]+kf[2]).M(), weight);
	  ...
	  hPJpsisub5->Fill( (kf[1]+kf[2]).P(), weight);
	  hFermiPPJpsisub5->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	}
      }

      //case 6
      if (CheckAcceptance(kf[1], 11.0, 29.0) * CheckAcceptance(kf[2], 11.0, 29.0) * CheckAcceptance(kf[0], 11.0, 29.0)){
	hMJpsi6->Fill( (kf[1]+kf[2]).M(), weight);
	...
	hPJpsi6->Fill( (kf[1]+kf[2]).P(), weight);
	hFermiPPJpsi6->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	
	if (ki[0].E() < 8.2){
	  hMJpsisub6->Fill( (kf[1]+kf[2]).M(), weight);
	  ...
	  hPJpsisub6->Fill( (kf[1]+kf[2]).P(), weight);
	  hFermiPPJpsisub6->Fill( ki[1].P(), (kf[1]+kf[2]).P(), weight);
	}
      }
    }
