...
int main(const int argc, const char * argv[]){
  ...
  // raw
  TFile * fraw = new TFile("result/Draw.root", "RECREATE");  
  ...
  // subthreshold
  TFile * fsub = new TFile("result/Dsub.root", "RECREATE");
  ...
  // detected
  TFile * fdetected = new TFile("result/Ddetected.root", "RECREATE");
  ...
  TFile * fdetectedsub = new TFile("result/Ddetectedsub.root", "RECREATE");
