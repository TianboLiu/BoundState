...
int main(const int argc, const char * argv[]){
  ...
  GENERATE::perange[1] = 5.6;//GeV
  

  // raw
  TFile * fraw = new TFile("result-electro/Draw.root", "RECREATE");  
  ...
  // subthreshold
  TFile * fsub = new TFile("result-electro/Dsub.root", "RECREATE");
  ...
  // detected
  TFile * fdetected = new TFile("result-electro/Ddetected.root", "RECREATE");
  ...
  TFile * fdetectedsub = new TFile("result-electro/Ddetectedsub.root", "RECREATE");
  ...
  for (Long64_t i = 0; i < Nsim; i++){
    ...
    if (weight > 0.0){
      acceptance = DETECTOR::AcceptanceCLAS12(kf[2], "e+") * DETECTOR::AcceptanceCLAS12(kf[3], "e-");
      ...
      hMJpsi3->Fill( (kf[2]+kf[3]).M(), weight * acceptance);
      hMomentum3->Fill( kf[2].P(), kf[3].P(), weight * acceptance);
      hThetaPelectron3->Fill( kf[3].Theta()/M_PI*180, kf[3].P(), weight * acceptance);
      hThetaPpositron3->Fill( kf[2].Theta()/M_PI*180, kf[2].P(), weight * acceptance);
      hThetaPproton3->Fill( kf[1].Theta()/M_PI*180, kf[1].P(), weight * acceptance);
      hAngleP3->Fill( kf[3].Angle(kf[2].Vect())/M_PI*180, kf[2].P(), weight * acceptance);
      hFermiP3->Fill( ki[1].P(), weight * acceptance);
      hFermiPz3->Fill( ki[1].Pz(), weight * acceptance);
      hPJpsi3->Fill( (kf[2]+kf[3]).P(), weight * acceptance);
      hFermiPPJpsi3->Fill( ki[1].P(), (kf[2]+kf[3]).P(), weight * acceptance);
	...
	hMJpsi4->Fill( (kf[2]+kf[3]).M(), weight * acceptance);
	hMomentum4->Fill( kf[2].P(), kf[3].P(), weight * acceptance);
	hThetaPelectron4->Fill( kf[3].Theta()/M_PI*180, kf[3].P(), weight * acceptance);
	hThetaPpositron4->Fill( kf[2].Theta()/M_PI*180, kf[2].P(), weight * acceptance);
	hThetaPproton4->Fill( kf[1].Theta()/M_PI*180, kf[1].P(), weight * acceptance);
	hAngleP4->Fill( kf[3].Angle(kf[2].Vect())/M_PI*180, kf[2].P(), weight * acceptance);
	hFermiP4->Fill( ki[1].P(), weight * acceptance);
	hFermiPz4->Fill( ki[1].Pz(), weight * acceptance);
	hPJpsi4->Fill( (kf[2]+kf[3]).P(), weight * acceptance);
	hFermiPPJpsi4->Fill( ki[1].P(), (kf[2]+kf[3]).P(), weight * acceptance);
      }
    }
