...
int main(const int argc, const char * argv[]){
  ...
  // raw
  TFile * fraw = new TFile("result-electro/praw.root", "RECREATE");  
  ...
  // subthreshold
  TFile * fsub = new TFile("result-electro/psub.root", "RECREATE");
  ...
  // detected
  TFile * fdetected = new TFile("result-electro/pdetected.root", "RECREATE");
  ...
  TFile * fdetectedsub = new TFile("result-electro/pdetectedsub.root", "RECREATE");
