...
int main(const int argc, const char * argv[]){
  ...
  TH1D * hRealEg2 = new TH1D("RealEg_above", ";E_{#gamma} (GeV);Events / hour", 140, 7.0, 8.4);
  TH2D * hkappaEg2  = new TH2D("kappaEg_above", ";#kappa_{J/#psi} (GeV);E_{#gamma} (GeV)", 100, 0.0, 1.0, 140, 7.0, 8.4);
  TH2D * hkappaEgLow2 = new TH2D("kappaEgLow_above", ";#kappa_{J/#psi} (GeV);E_{#gamma} (GeV)", 100, 0.0, 1.0, 140, 7.0, 8.4);
  TH2D * hkappaEgHigh2 = new TH2D("kappaEgHigh_above", ";#kappa_{J/#psi} (GeV);E_{#gamma} (GeV)", 100, 0.0, 1.0, 140, 7.0, 8.4);
