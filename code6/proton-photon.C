...
int main(const int argc, const char * argv[]){
  ...
  // raw
  TFile * fraw = new TFile("result-photon/praw.root", "RECREATE");  
  ...
  // subthreshold
  TFile * fsub = new TFile("result-photon/psub.root", "RECREATE");
  ...
  // detected
  TFile * fdetected = new TFile("result-photon/pdetected.root", "RECREATE");
  ...
  TFile * fdetectedsub = new TFile("result-photon/pdetectedsub.root", "RECREATE");
