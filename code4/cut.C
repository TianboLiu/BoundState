...
int main(const int argc, const char * argv[]){
  ...
  TFile * fs = new TFile("result/cut.root", "RECREATE");
  ...
  TH1D * h5 = new TH1D("MpKK_PiPi", "", 2200, 1.88, 2.32);
  ...
  TH1D * h5a = new TH1D("MpKp_PiPi", "", 2200, 1.38, 1.82);
  ...
  TH1D * h5b = new TH1D("MpKm_PiPi", "", 2200, 1.38, 1.82);
  ...
  TH1D * h5c = new TH1D("MKK_PiPi", "", 2200, 0.98, 1.42);
  ...
  TH2D * d5a = new TH2D("Momentum_p_Kp_PiPi", "", 100, 0.0, 2.0, 100, 0.0, 2.0);
  TH2D * d5b = new TH2D("Momentum_p_Km_PiPi", "", 100, 0.0, 2.0, 100, 0.0, 2.0);
  TH2D * d5c = new TH2D("Momentum_Kp_Km_PiPi", "", 100, 0.0, 2.0, 100, 0.0, 2.0);
  ...
  TH2D * r5a = new TH2D("PTheta_p_PiPi", "", 90, 0.0, 90.0, 100, 0.0, 2.0);
  TH2D * r5b = new TH2D("PTheta_Kp_PiPi", "", 90, 0.0, 90.0, 100, 0.0, 2.0);
  TH2D * r5c = new TH2D("PTheta_Km_PiPi", "", 90, 0.0, 90.0, 100, 0.0, 2.0);
  ...
  for (Long64_t i = 0; i < Nsim; i++){
	...
	Pc = kf[2] + kf[3];
	h5->Fill(PP.M(), weight);
	h5a->Fill(Pa.M(), weight);
	h5b->Fill(Pb.M(), weight);
	h5c->Fill(Pc.M(), weight);
	d5a->Fill(kf[2].P(), kf[1].P(), weight);
	d5b->Fill(kf[3].P(), kf[1].P(), weight);
	d5c->Fill(kf[2].P(), kf[3].P(), weight);
	r5a->Fill(kf[1].Theta() * deg, kf[1].P(), weight);
	r5b->Fill(kf[2].Theta() * deg, kf[2].P(), weight);
	r5c->Fill(kf[3].Theta() * deg, kf[3].P(), weight);
      }
    }
