...
int main(const int argc, const char * argv[]){
  ...
  if (argc < 4) {
    cout << "./plotter <opt> <loadpath> <savepath>" << endl;
    return 1;
  }
  ...
  double lumi = 1.0e31 * 1.0e-26 * pow(Phys::hbar, 2) / GOLD::NA;//eA GeV^2 s^-1
  double time = 3600.0;

  TString loadpath = argv[2];
  TString savepath = argv[3];

  TH1D * hB = new TH1D("hB", "", 200, 0.5, 2.5);
  ...
  if (opt == 10){//invariant mass vertex
    TFile * fs = new TFile(loadpath + "raw-photon.root", "r");
    ...
    hB->SetMaximum(h4a->GetMaximum() * 1.5);
    ...
    leg->DrawClone("same");
    c0->Print(savepath + "Massraw.pdf","pdf");//
    hB->SetMaximum(h4b->GetMaximum() * 1.5);
    hB->SetAxisRange(1.38, 1.81, "X");
    hB->GetXaxis()->SetTitle("M(pK^{-}) (GeV)");
    hB->DrawClone("axis");
    h0b->DrawClone("same");
    ...
    leg->DrawClone("same");
    c0->Print(savepath + "Massraw.pdf","pdf");//
    hB->SetMaximum(h4c->GetMaximum() * 1.5);
  ...
  if (opt == 11){//Momentum vertex
    ...
    d0a->GetXaxis()->SetRangeUser(0.0, 1.5);
    ...
    d0a->GetYaxis()->SetRangeUser(0.0, 1.5);
    ...
    d0b->GetXaxis()->SetRangeUser(0.0, 1.5);
    ...
    d0b->GetYaxis()->SetRangeUser(0.0, 1.5);
    ...
    d0c->GetXaxis()->SetRangeUser(0.0, 1.5);
    ...
    d0c->GetYaxis()->SetRangeUser(0.0, 1.5);
    ...
    g4a->DrawClone("psame");
    leg->DrawClone("same");
    c0->Print(savepath + "Momentumraw.pdf(","pdf");//
  ...
  if (opt == 12){//P-theta vertex
    ...
    rB->DrawClone("axis");
    r0a->Draw("colsame");
    c0->Print(savepath + "PThetaraw.pdf(", "pdf");
  ...
  if (opt == 20){//invariant mass detected
    TFile * fs = new TFile(loadpath + "detected-photon.root", "r");
    TH1D * h0 = (TH1D *) fs->Get("MpKK_BoundStateAll");
    TH1D * h1 = (TH1D *) fs->Get("MpKK_BoundStateKK");
    TH1D * h2 = (TH1D *) fs->Get("MpKK_phi");
    TH1D * h3 = (TH1D *) fs->Get("MpKK_Lambda1520");
  ...
  if (opt == 21){//Momentum detected
    ...
    g4a->DrawClone("psame");
    leg->DrawClone("same");
    c0->Print(savepath + "Momentumdetected.pdf(","pdf");//
    d0a->SetTitle("pKK from N-#phi");
    d0a->DrawClone("axis");
    d0a->DrawClone("colsame");
    c0->Print(savepath + "Momentumdetected.pdf","pdf");//
  ...
  if (opt == 22){//P-theta detected
    ...
    rB->DrawClone("axis");
    r0a->Draw("colsame");
    c0->Print(savepath + "PThetadetected.pdf(", "pdf");
    rB->SetTitle("K^{+} from N-#phi");
    rB->DrawClone("axis");
    r0b->Draw("colsame");
    c0->Print(savepath + "PThetadetected.pdf", "pdf");
  ...
  if (opt == 30){//invariant mass smeared
    TFile * fs = new TFile(loadpath + "smeared-photon.root", "r");
    TH1D * h0 = (TH1D *) fs->Get("MpKK_BoundStateAll");
    TH1D * h1 = (TH1D *) fs->Get("MpKK_BoundStateKK");
    TH1D * h2 = (TH1D *) fs->Get("MpKK_phi");
    TH1D * h3 = (TH1D *) fs->Get("MpKK_Lambda1520");
  ...
  if (opt == 31){//Momentum smeared
    ...
    g4a->DrawClone("psame");
    leg->DrawClone("same");
    c0->Print(savepath + "Momentumsmeared.pdf(","pdf");//
    d0a->SetTitle("pKK from N-#phi");
    d0a->DrawClone("axis");
    d0a->DrawClone("colsame");
    c0->Print(savepath + "Momentumsmeared.pdf","pdf");//
  ...
  if (opt == 32){//P-theta smeared
    ...
    rB->DrawClone("axis");
    r0a->Draw("colsame");
    c0->Print(savepath + "PThetasmeared.pdf(", "pdf");
    rB->SetTitle("K^{+} from N-#phi");
    rB->DrawClone("axis");
    r0b->Draw("colsame");
    c0->Print(savepath + "PThetasmeared.pdf", "pdf");
  ...
  if (opt == 40){//invariant mass cut
    TFile * fs = new TFile(loadpath + "cut-photon.root", "r");
    TH1D * h0 = (TH1D *) fs->Get("MpKK_BoundStateAll");
    TH1D * h1 = (TH1D *) fs->Get("MpKK_BoundStateKK");
    TH1D * h2 = (TH1D *) fs->Get("MpKK_phi");
    TH1D * h3 = (TH1D *) fs->Get("MpKK_Lambda1520");
  ...
  if (opt == 41){//Momentum cut
    ...
    g4a->DrawClone("psame");
    leg->DrawClone("same");
    c0->Print(savepath + "Momentumcut.pdf(","pdf");//
    d0a->SetTitle("pKK from N-#phi");
    d0a->DrawClone("axis");
    d0a->DrawClone("colsame");
    c0->Print(savepath + "Momentumcut.pdf","pdf");//
  ...
  if (opt == 42){//P-theta cut
    ...
    rB->DrawClone("axis");
    r0a->Draw("colsame");
    c0->Print(savepath + "PThetacut.pdf(", "pdf");
    rB->SetTitle("K^{+} from N-#phi");
    rB->DrawClone("axis");
    r0b->Draw("colsame");
    c0->Print(savepath + "PThetacut.pdf", "pdf");
  ...
  if (opt == 5){//Two pions new
    ...
    c0->SetLeftMargin(0.15);
    c0->SetBottomMargin(0.15);
    hB->SetMaximum(h1->GetMaximum() * 1.2);
    hB->SetAxisRange(1.91, 2.05, "X");
    hB->SetXTitle("M(pKK) (GeV)");
    hB->SetYTitle("counts / hour / MeV");
    hB->DrawClone("axis");
    h0->DrawClone("same");
    h1->DrawClone("same");
    leg->DrawClone("same");
    c0->Print(savepath + "TwoPionsNew.pdf(","pdf");//
    hB->SetMaximum(h1a->GetMaximum() * 1.2);
    hB->SetAxisRange(1.4, 1.5, "X");
    hB->SetXTitle("M(pK^{+}) (GeV)");
    hB->DrawClone("axis");
    h0a->DrawClone("same");
    h1a->DrawClone("same");
    leg->DrawClone("same");
    c0->Print(savepath + "TwoPionsNew.pdf","pdf");//
    hB->SetMaximum(h1b->GetMaximum() * 1.2);
    hB->SetAxisRange(1.4, 1.5, "X");
    hB->SetXTitle("M(pK^{-}) (GeV)");
    hB->DrawClone("axis");
    h0b->DrawClone("same");
    ...
    leg->DrawClone("same");
    c0->Print(savepath + "TwoPionsNew.pdf","pdf");//
    hB->SetMaximum(h1c->GetMaximum() * 1.2);
    hB->SetAxisRange(0.98, 1.05, "X");
    hB->SetXTitle("M(K^{+}K^{-}) (GeV)");
    hB->DrawClone("axis");
    h0c->DrawClone("same");
    h1c->DrawClone("same");
    leg->DrawClone("same");
  ...
  if (opt == 6){//
    TFile * fs = new TFile(loadpath + "cut-photon.root", "r");
    TFile * fsp = new TFile(loadpath + "breakcut-photon.root", "r");
    TFile * f2pi = new TFile(loadpath + "twopinew.root", "r");
    TH1D * h0 = (TH1D *) fs->Get("MpKK_BoundStateAll");
    TH1D * h1 = (TH1D *) fs->Get("MpKK_BoundStateKK");
    TH1D * h2 = (TH1D *) fs->Get("MpKK_phi");
    ...
    cout << "KK:     " << h4p->Integral(bin1, bin2) * lumi * time << endl;
    cout << "PiPi:   " << h5->Integral(bin1, bin2) * lumi * time / mispid << endl;
  }

  if (opt == 7){//
    TFile * fs = new TFile(loadpath + "cut-photon.root", "r");
    TFile * fsp = new TFile(loadpath + "breakthetacut-photon.root", "r");
    TFile * f2pi = new TFile(loadpath + "twopinew.root", "r");
    TH1D * h0 = (TH1D *) fs->Get("MpKK_BoundStateAll");
    TH1D * h1 = (TH1D *) fs->Get("MpKK_BoundStateKK");
    TH1D * h2 = (TH1D *) fs->Get("MpKK_phi");
  ...
  if (opt == -30){//invariant mass smeared break
    ...
    c0->SetLeftMargin(0.15);
    c0->SetBottomMargin(0.15);
    hB->SetMaximum(h2->GetMaximum() * 1.2);
    hB->SetAxisRange(1.88, 2.31, "X");
    hB->GetXaxis()->SetTitle("M(pKK) (GeV)");
    hB->GetYaxis()->SetTitle("counts / hour / MeV");
    hB->DrawClone("axis");
  ...
  if (opt == -31){//Momentum smeared break
    ...
    g4a->DrawClone("psame");
    leg->DrawClone("same");
    c0->Print(savepath + "Momentumbreak.pdf(","pdf");//
    d0a->SetTitle("pKK from N-#phi");
    d0a->DrawClone("axis");
    d0a->DrawClone("colsame");
    c0->Print(savepath + "Momentumbreak.pdf","pdf");//
  ...
  if (opt == -41){//Momentum cut
    ...
    g4a->DrawClone("psame");
    leg->DrawClone("same");
    c0->Print(savepath + "Momentumbreakcut.pdf(","pdf");//
    d0a->SetTitle("pKK from N-#phi");
    d0a->DrawClone("axis");
    d0a->DrawClone("colsame");
    c0->Print(savepath + "Momentumbreakcut.pdf","pdf");//
  ...
  if (opt == -42){//P-theta cut
    ...
    rB->DrawClone("axis");
    r0a->Draw("colsame");
    c0->Print(savepath + "PThetabreakcut.pdf(", "pdf");
    rB->SetTitle("K^{+} from N-#phi");
    rB->DrawClone("axis");
    r0b->Draw("colsame");
    c0->Print(savepath + "PThetabreakcut.pdf", "pdf");
  ...
  if (opt == -411){//Momentum cut
    ...
    g4a->DrawClone("psame");
    leg->DrawClone("same");
    c0->Print(savepath + "Momentumbreakthetacut.pdf(","pdf");//
    d0a->SetTitle("pKK from N-#phi");
    d0a->DrawClone("axis");
    d0a->DrawClone("colsame");
    c0->Print(savepath + "Momentumbreakthetacut.pdf","pdf");//
  ...
  if (opt == -421){//P-theta cut
    ...
    rB->DrawClone("axis");
    r0a->Draw("colsame");
    c0->Print(savepath + "PThetabreakthetacut.pdf(", "pdf");
    rB->SetTitle("K^{+} from N-#phi");
    rB->DrawClone("axis");
    r0b->Draw("colsame");
    c0->Print(savepath + "PThetabreakthetacut.pdf", "pdf");
  ...
  if (opt == -402){//invariant mass cut
    ...
    h4->DrawClone("same");
    leg->DrawClone("same");
    c0->Print(savepath + "Massbreakbtbcut.pdf(","pdf");//
    hB->SetMaximum(h4a->GetMaximum() * 1.5);
    hB->SetAxisRange(1.38, 1.81, "X");
    hB->GetXaxis()->SetTitle("M(pK^{+}) (GeV)");
    hB->DrawClone("axis");
  ...
  if (opt == -412){//Momentum cut
    ...
    g4a->DrawClone("psame");
    leg->DrawClone("same");
    c0->Print(savepath + "Momentumbreakbtbcut.pdf(","pdf");//
    d0a->SetTitle("pKK from N-#phi");
    d0a->DrawClone("axis");
    d0a->DrawClone("colsame");
    c0->Print(savepath + "Momentumbreakbtbcut.pdf","pdf");//
  ...
  if (opt == -422){//P-theta cut
    ...
    rB->DrawClone("axis");
    r0a->Draw("colsame");
    c0->Print(savepath + "PThetabreakbtbcut.pdf(", "pdf");
    rB->SetTitle("K^{+} from N-#phi");
    rB->DrawClone("axis");
    r0b->Draw("colsame");
    c0->Print(savepath + "PThetabreakbtbcut.pdf", "pdf");
